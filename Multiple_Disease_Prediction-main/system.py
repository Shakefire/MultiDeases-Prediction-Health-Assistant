...
with st.sidebar:
    st.session_state.patient_name = st.text_input(
        "Patient Name", "John Doe", key="patient_name_input")
...
if selected == 'Diabetes Prediction':
    ...
    if st.button('Predict Diabetes Risk', key="diab_btn"):
        ...
        # Gamification
        if prediction == 1:
            st.subheader("💪 Prevention Challenge")
            if st.checkbox("Log today's healthy meal", key="diab_chk1"):
                update_gamification()
            st.write(f"🏆 Health Points: {st.session_state.health_points}")
...
if selected == 'Heart Disease Prediction':
    ...
    if st.button('Predict Heart Disease Risk', key="heart_btn"):
        ...
        # Gamification
        if prediction == 1:
            st.subheader("❤️ Heart Health Challenge")
...
if selected == 'Parkinsons Prediction':
    ...
    if st.button("Predict Parkinson's Risk", key="park_btn"):
        ...
        # Gamification
        if prediction == 1:
            st.subheader("🧠 Brain Health Challenge")
...
if selected == 'Breast Cancer Prediction':
    ...
    if st.button('Predict Breast Cancer Risk', key="bc_btn"):
        ...
        # Explainable AI
        st.subheader("🔍 Key Tumor Characteristics")
...
if selected == 'Liver Disease Prediction':
    ...
    if st.button('Predict Liver Disease Risk', key="liver_btn"):
        ...
        # Gamification
        if prediction == 1:
            st.subheader("🍏 Liver Health Challenge")
